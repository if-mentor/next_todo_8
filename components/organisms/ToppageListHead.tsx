    ...
    <>
      <Thead backgroundColor={"#95E3F4"}>
        <Tr>
          ...
          <Th textTransform="none" fontSize="24px" fontWeight="700" maxW={"140px"} minW={"140px"} p={"16px 10px"}><Center>Create</Center></Th>
          <Th textTransform="none" fontSize="24px" fontWeight="700" maxW={"140px"} minW={"140px"} p={"16px 10px"}><Center>Update</Center></Th>
          <Th textTransform="none" fontSize="24px" fontWeight="700" maxW={"115px"} minW={"115px"} p={"16px 10px"}><Center>Action</Center></Th>
        </Tr>
      </Thead>
    </>
  )
